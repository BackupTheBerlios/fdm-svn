...
#if !defined(FDM_PROP_PAGE_H)
#define FDM_PROP_PAGE_H
...
class FdmSettingsManager;
#include "../../Fdm-Client/dcplusplus-rips/Fdm-ResourceManager.h"

class FdmPropPage
{
public:
	FdmPropPage(FdmSettingsManager *src) : settings(src) { }
	virtual ~FdmPropPage() { }
	...
	struct ListItem {
		int setting;
		FdmResourceManager::FdmStrings desc;
	};
	struct TextItem {
		WORD itemID;
		FdmResourceManager::FdmStrings translatedString;
	};

protected:

	FdmSettingsManager *settings;
