...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		FDM_LANGUAGE_FILE, AUTO_SEARCH_FRAME_ORDER, AUTO_SEARCH_FRAME_WIDTHS, WINAMP_FORMAT, 
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		//Fdm
		OP_SPOKE_COLOUR, NOT_OP_SPOKE_COLOUR, I_SPOKE_COLOUR, MY_NICK_SPOKEN_COLOUR, SHOW_IPS_IN_CHAT, SHOW_CC_IN_CHAT,

		//BCDC++
		MAX_UPLOAD_SPEED, MAX_DOWNLOAD_SPEED_REAL, THROTTLE_ENABLE,
