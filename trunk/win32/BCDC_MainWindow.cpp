...
void MainWindow::bcdcThrottleSetup() {
	...
	dcdebug("bandwidth up %d\n", SettingsManager::MAX_UPLOAD_SPEED_YAY_ANOTHER_LEVEL_OF_INDIRECTION_GO_GO_GO);
	dcdebug("bandwidth down %d\n", SettingsManager::MAX_DOWNLOAD_SPEED_REAL_A_PARALLEL_LEVEL_OF_HOPEFULLY_USEFUL_INDIRECTION_IN_AN_ABSURDLY_LONG_IDENTIFIER);
}
